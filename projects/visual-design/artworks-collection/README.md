...
### 1. Elementos de Arte Frontal (Ilustração & Fantasia)
Uma composição épica mostrando o confronto entre um mago e uma criatura demoníaca com efeitos de glitch digital e aura mágica.
![Elementos de Arte Frontal](assets/1.png)

### 2. Design de Vestuário - UNIFEI / Ciências de Dados Aplicada
Design de camiseta para a Universidade Federal de Itajubá (UNIFEI), turma de Ciências de Dados Aplicada. Apresenta elementos tecnológicos (engrenagem, circuito, raio) com uma estética cyberpunk/neon.
![Camiseta UNIFEI](assets/UNIFEI.png)

### 3. Nikola Tesla - Selfie (Manipulação Criativa)
...
![Nikola Tesla Selfie](assets/Nikola%20Tesla%20-twitter.jpg)

### 4. Banner Social Media - Copa Odin (Ragnarok Origin)
...
![Banner Ragnarok Origin](assets/Odin%20Cup.png)

### 5. Projeto Padaria
*(Adicione aqui uma breve descrição sobre o projeto de visual design da Padaria)*
![Projeto Padaria](assets/PADARIA.jpg)

### 6. Arte / Retrato - Sayuri
*(Adicione aqui uma breve descrição sobre este retrato/arte)*
![Arte Sayuri](assets/Sayuri2.jpeg)

### 7. MNHI 3.0 - Arquitetura Sentiente Hiperbólica
